    ...
    <Container className="py-16">
      ...
      {grupo.orientacoesGrupo && grupo.orientacoesGrupo.length > 0 && (
        <section className="mt-16">
          ...
          <div className="mt-6 max-w-[var(--largura-conteudo)] text-[var(--nevoa)] [&>h2]:mt-6 [&>h2]:[font-family:var(--fonte-display)] [&>h2]:text-lg [&>h2]:font-bold [&>p+p]:mt-4 [&>ul]:mt-3 [&>ul]:list-disc [&>ul]:pl-5">
