...
export function Carimbo({ depoimento }: { depoimento: Depoimento }) {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="font-[var(--fonte-display)] text-xs font-bold uppercase tracking-[0.05em]">
          {depoimento.nome}
        </span>
        {depoimento.cidade && (
          <span className="font-[var(--fonte-dados)] text-[10px] uppercase">{depoimento.cidade}</span>
        )}
        {depoimento.saida?.dataInicio && (
          <span className="font-[var(--fonte-dados)] text-[10px] uppercase [font-variant-numeric:tabular-nums]">
      ...
      {aberto && (
        ...
        >
          <p className="font-[var(--fonte-citacao)] italic text-[var(--azul-profundo)]">
            &ldquo;{depoimento.texto}&rdquo;
          </p>
          <p className="mt-2 font-[var(--fonte-dados)] text-xs uppercase tracking-[0.05em] text-[var(--tinta-carimbo)]">
            {depoimento.nome}
