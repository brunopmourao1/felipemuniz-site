...
export function BotaoWhatsApp({ numero }: { numero: string }) {
  return (
    <a
      ...
      className="whatsapp-flutuante fixed bottom-4 right-4 z-40 flex h-14 w-14 items-center justify-center rounded-[var(--raio-m)] bg-[var(--sucesso)] text-[var(--nevoa)] shadow-lg transition-transform hover:scale-105 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--amarelo-seta)]"
    >
